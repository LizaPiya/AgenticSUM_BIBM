#!/bin/bash
#SBATCH --job-name=qwen3b_mimic_judge
...
#SBATCH --mem=32G
#SBATCH --gres=gpu:1
#SBATCH --output=/home/lizapiya/MLHC_AgenticSUM/outputs/agenticsum/qwen3b_mimic_judge_%j.log
#SBATCH --error=/home/lizapiya/MLHC_AgenticSUM/outputs/agenticsum/qwen3b_mimic_judge_%j.err
