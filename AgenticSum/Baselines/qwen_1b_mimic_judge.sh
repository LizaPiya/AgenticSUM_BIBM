#!/bin/bash
#SBATCH --job-name=qwen1b_mimic_judge
...
#SBATCH --mem=32G
#SBATCH --gres=gpu:1
#SBATCH --output=/home/lizapiya/MLHC_AgenticSUM/outputs/agenticsum/qwen1b_mimic_judge_%j.log
#SBATCH --error=/home/lizapiya/MLHC_AgenticSUM/outputs/agenticsum/qwen1b_mimic_judge_%j.err
