"""
Generate and evaluate Qwen2.5 summaries on MIMIC-IV for Table 1.
Usage:
...
OUTPUT_PATH = f"{OUTPUT_DIR}/{MODEL_TAG}_mimic_summaries.csv"
...
print(f"Loaded {len(df)} MIMIC notes.")
...
# ──────────────────────────────────────────────
print("\n" + "="*60)
print(f"TABLE 1 ROW  —  {MODEL_NAME}  (MIMIC-IV)")
print("="*60)
