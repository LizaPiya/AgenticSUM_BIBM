...
# ======================================================
# Load dataset — first 100 SOAP notes
# ======================================================
...
final_output_path = f"{output_dir}/agenticsum_results_soap.csv"
...
# ======================================================
print("="*80)
print("Starting AgenticSum Pipeline — SOAP (100 notes)")
print("="*80 + "\n")
...
with torch.no_grad():
    for batch_start in range(0, len(df), BATCH_SIZE):
        ...
        checkpoint_path = f"{output_dir}/checkpoints_soap/batch_{batch_start//BATCH_SIZE + 1}.csv"
